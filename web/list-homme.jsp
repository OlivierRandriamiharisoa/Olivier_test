        ...
        <div class="col-sm-10 col-sm-offset-3 col-lg-1O col-lg-offset-2 main">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 class="text-center">Listes des touts personnes</h3>
                    <hr>
                     
                        <a href="<%=request.getContextPath()%>/new" class="btn btn-success">Ajouter nouveau personnes</a>
                        ...
                        <tbody>       
                            <c:forEach var="homme" items="${listHomme}">
                                <tr>
                                    ...
                                    <td><c:out value="${homme.dece}" /></td>
                                    <td > 
                                       <a class="btn btn-success btn-sm" href="edit?id=<c:out value='${homme.id}' />"><em class="fa fa-edit"></em></a>
                                        <a class="btn btn-danger btn-sm" href="delete?id=<c:out value='${homme.id}' />"><em class="fa fa-trash"></em></a> 
                                   </td>
                                </tr>
                            </c:forEach>  
                        </tbody>
