<%-- 
    Document   : listVote
    Created on : 22 mars 2022, 07:41:13
    Author     : Ra.Oli
--%>
        ...
        <div class="col-sm-10 col-sm-offset-3 col-lg-1O col-lg-offset-2 main">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3 class="text-center">Listes des bureaus des votes</h3>
                    <hr>
                    <div class="container text-left">

                        <a href="<%=request.getContextPath()%>/new3" class="btn btn-success">Ajouter nouveau bureau</a>
                    ...
                    <table class="table table-bordered table-striped ">          
                        ...
                        <tbody>       
                            <c:forEach var="vote" items="${listVote}">
                                <tr>
                                    <td><c:out value="${vote.idv}"/></td>
                                    <td><c:out value="${vote.lieu}"/></td>
                           <!--td > 
