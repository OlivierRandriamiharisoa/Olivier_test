        ...
        <div class="col-sm-11 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="panel panel-default">
                <div class="panel-body">
                   <h3 class="text-center">Liste des morts</h3>
                     <hr>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>       
                        <c:forEach var="homme" items="${listDec}">
                            <tr>
                                ...
                                <!--td ><a class="btn btn-success btn-sm" href="edit1?id=<c:out value='${homme.id}' />"><em class="fa fa-edit"></em></a>
