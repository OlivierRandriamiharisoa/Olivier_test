       ...
       <br>
        <div class="col-sm-11 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            <div class="panel panel-default">
                ...
                <h3 class="text-center">Listes des mineurs</h3>
                <hr>
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>       
                        <c:forEach var="homme" items="${listMin}">
                            <tr>
                                ...
                                <!--td ><a class="btn btn-success btn-sm" href="edit?id=<c:out value='${homme.id}' />"><em class="fa fa-edit"></em></a>
